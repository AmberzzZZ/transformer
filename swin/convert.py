...
keras_model_swin = SwinTransformer(patch_size=4, emb_dim=128, n_classes=21841, num_layers=[2,2,18,2],
                                    num_heads=[4,8,16,32], window_size=7, qkv_bias=True, qk_scale=None,
                                    mlp_ratio=4, attn_drop=0., ffn_drop=0., residual_drop=0.3)
...
keras_model_swin.save_weights('weights/swin_base_patch4_window7_224_22k.h5')
